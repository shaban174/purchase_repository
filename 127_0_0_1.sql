...
('root', '[{\"db\":\"purchase_system\",\"table\":\"organization_assets\"},{\"db\":\"purchase_system\",\"table\":\"vendor\"}]');
...
('root', '2024-03-21 07:39:09', '{\"Console\\/Mode\":\"collapse\"}');
...
--
CREATE DATABASE IF NOT EXISTS `purchase_system` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `purchase_system`;
...
--
-- Table structure for table `purchase_form_data`
--

CREATE TABLE `purchase_form_data` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `purchase_form_data`
--
ALTER TABLE `purchase_form_data`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `purchase_form_data`
--
ALTER TABLE `purchase_form_data`
